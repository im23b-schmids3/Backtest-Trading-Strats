...
LEVEL_NAMES = (
    ...
    "PRIOR_EUROPE_SESSION_HIGH", "PRIOR_EUROPE_SESSION_LOW", "PRIOR_EUROPE_SESSION_POC",
    "PRIOR_EUROPE_SESSION_VAH", "PRIOR_EUROPE_SESSION_VAL",
    "CURRENT_EUROPE_HIGH_SWEEP", "CURRENT_EUROPE_LOW_SWEEP",
    "PRIOR_ASIA_SESSION_HIGH", "PRIOR_ASIA_SESSION_LOW", "PRIOR_ASIA_SESSION_POC",
    "PRIOR_ASIA_SESSION_VAH", "PRIOR_ASIA_SESSION_VAL",
    "CURRENT_ASIA_HIGH_SWEEP", "CURRENT_ASIA_LOW_SWEEP",
    "PRIOR_NY_RTH_HIGH", "PRIOR_NY_RTH_LOW", "PRIOR_NY_RTH_POC", "PRIOR_NY_RTH_VAH",
    "PRIOR_NY_RTH_VAL", "COMPLETED_EUROPE_SESSION_POC",
    "COMPLETED_EUROPE_SESSION_VAH", "COMPLETED_EUROPE_SESSION_VAL",
)
