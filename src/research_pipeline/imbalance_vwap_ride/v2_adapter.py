...
from .footprint import (
    ...
    load_footprint_dataset,
    validate_footprint_dataset,
    validate_source_manifest,
)
from .v2_models import ADAPTER_ID, DATASET_HASH, STRATEGY_ID, ImbalanceVWAPRideV2Config
from .v2_strategy import run_imbalance_vwap_ride_v2


class ImbalanceVWAPRideV2Adapter:
    """Local-only V2 adapter over the immutable standalone footprint engine."""
    ...
    def validate_source(self, manifest_path: str | Path, *, verify_hashes: bool = True) -> dict[str, Any]:
        return validate_source_manifest(
            manifest_path,
            require_pinned=True,
            verify_parquet_hashes=verify_hashes,
        )
    ...
    def run_split(
        ...
        *,
        ...
        return run_imbalance_vwap_ride_v2(bars, footprints, config)
